...
/**
 * A minimalistic Mock which is going to reply to specified requests in a specified manner:
 * <ol>
 ...
 * </ol>
 * 
 * Usage: Start this app and connect to the socket via client, e.g. telnet: 'telnet localhost 4321'
 * 
