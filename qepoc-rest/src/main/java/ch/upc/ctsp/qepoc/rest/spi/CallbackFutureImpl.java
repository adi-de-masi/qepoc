...
public class CallbackFutureImpl<V> implements CallbackFuture<V> {
    ...
    public void takeResultFrom(final CallbackFuture<V> sourceCallback) {
        sourceCallback.registerCallback(new CallbackHandler<V>() {
        ...
        setPollerHandler(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    throw new RuntimeException("Exception while waiting for result", e);
                }
            }
        });
    }
